var vm = Vue.createApp({
  ...
  watch: {
    ...
    values: {
      // 잘돌아가는 보완소스
      // 위의 values(){}안의 실행문은 문제 없기 때문에 실행문들을 그대로 가져오고, handler 익명함수 쓰고 그안에 넣어준다. 그후 deep: true라고 설정하면 values:{} 하위의 모든값을 감지하게된다
      ...
      // 한국인은 서비스의 규모랑 상관없이 빠른것을 사랑한다. 소스를 줄여 쓴다고 했을때 가독성 나빠지고, 성능이 저하된다면 굳이 하지 않아도 되는 행동이라고 생각됨.
    },
  },
}).mount("#app");